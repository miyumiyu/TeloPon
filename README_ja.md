...
👉 **[画像付きの詳しい取得手順はこちら（初心者向け）](ja/docs/04_get_apikey.md)**
...
* ▶️ **YouTube連携ツール** (`YoutubeLivePlugin.py`)  
  ...
  👉 [詳細な使い方はこちら](ja/docs/plugins/YoutubeLivePlugin.md)
...
* 💬 **Discordリアルタイム連携** (`discord_integration.py`)  
  ...
  👉 [詳細な使い方はこちら](ja/docs/plugins/discord_integration.md)
...
* 🏢 **Slackコメント連携** (`slack_integration.py`) 
 ...
 👉 [詳細な使い方はこちら](ja/docs/plugins/slack_integration.md)
...
* 🧠 **[AIプロンプト作成ガイド](ja/docs/01_prompt_guide.md)**: 自分専用のAIの作り方や絶対ルールについて。
* 🎨 **[テーマ・CSS カスタマイズガイド](ja/docs/02_theme_css.md)**: 自作デザインの作り方や効果音の鳴らし方。
* 🧩 **[プラグイン開発ガイド](ja/docs/03_plugin_dev.md)**: exe版に内蔵されたライブラリ（`requests`, `pytchat`, `obsws_python`, `Pillow` 等）を使った自作拡張機能の作り方。
