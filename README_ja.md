...
### 6. テロップ出力をリアルタイム確認「テロップモニター」
AIが出力したテロップをTeloPon画面上で時系列に確認できるモニターウィンドウ。配信中にOBSを確認しなくても、テロップ履歴がアプリ上で一目でわかります。
...
### 📺 9. テロップモニター
OBSコピーボタンの下にある **「テロップモニター OFF/ON」** ボタンで切り替えます。ONにすると、AIが出力したテロップの履歴をTeloPon画面上で時系列に確認できます。配信中にOBSを確認しなくても、テロップ履歴がアプリ上で一目でわかります。起動後にONにしても、それまでのログを遡って確認可能です。
