[English](https://github.com/miyumiyu/TeloPon/blob/main/docs/en/extend_plugins/ex-plugins-pack_v1.3.md) | **日本語** | [한국어](https://github.com/miyumiyu/TeloPon/blob/main/docs/ko/extend_plugins/ex-plugins-pack_v1.3.md) | [Русский](https://github.com/miyumiyu/TeloPon/blob/main/docs/ru/extend_plugins/ex-plugins-pack_v1.3.md)

TeloPonをさらに便利にするための「公式拡張プラグイン（連携機能）」の最新版です！
必要な機能のファイル（`.py`）だけをダウンロードして、お使いのTeloPonに追加してください。
**※V2.14b のバージョンから使えるようになります。**

## 📦 収録プラグイン

### 🆕 🔊 VOICEVOX読み上げ (`voicevox_plugin.py`)

![VOICEVOX読み上げ設定画面](https://github.com/miyumiyu/TeloPon/blob/main/images/voicevox_plugin.png?raw=true)
...
📥 [プラグインをダウンロード](https://github.com/miyumiyu/TeloPon/releases/download/plugins-v1.3/discord_integration.py)
...
📥 [プラグインをダウンロード](https://github.com/miyumiyu/TeloPon/releases/download/plugins-v1.3/slack_integration.py)
...
```
🔌 TeloPon 公式拡張プラグインパック v1.3 (VOICEVOX・Discord・Slack)
```
