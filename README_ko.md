...
| 플러그인 | 설명 |
|---|---|
| ▶️ **YouTube OAuth** | 댓글 읽기/쓰기, 설문, 제목 변경, 시청자 수 |
| 🔊 **Windows TTS** | Windows 내장 음성으로 읽기 |
| 🎮 **VCI OSC** | VirtualCast VCI로 OSC 전송 |
| 💬 **Discord** | Discord 채널 실시간 댓글 |
| 🏢 **Slack** | Slack 채널 실시간 댓글 |
| 🗣️ **VOICEVOX** | VOICEVOX 음성 합성 |
| 📊 **PowerPoint 조작** | 음성으로 슬라이드쇼 조작, 노트를 AI에 자동 주입 |
