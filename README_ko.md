...
### 6. 실시간 텔롭 이력 확인 "텔롭 모니터"
AI가 출력한 텔롭을 TeloPon 화면에서 시간순으로 확인할 수 있는 모니터 창. 방송 중에 OBS를 확인하지 않아도 텔롭 이력을 앱에서 한눈에 파악할 수 있습니다.
...
### 📺 9. 텔롭 모니터
OBS 복사 버튼 아래의 **「텔롭 모니터 OFF/ON」** 버튼으로 전환합니다. ON으로 설정하면 AI가 출력한 텔롭 이력을 TeloPon 화면에서 시간순으로 확인할 수 있습니다. 방송 중에 OBS를 확인하지 않아도 텔롭 이력을 앱에서 한눈에 파악할 수 있습니다. 실행 후에 ON으로 설정해도 이전 로그를 소급하여 확인 가능합니다.
