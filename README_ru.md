...
### 📺 9. TelopViewer（Просмотр телопов）
Откройте через кнопку **«Telop Viewer» → «Панель управления»** в панели расширений. Отображает историю телопов ИИ в реальном времени в хронологическом порядке. Поддерживает цветовую маркировку тегов B1/B2, а задержку отображения в OBS можно настроить через выпадающий список.
