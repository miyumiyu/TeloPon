...
<img src="images/demo.gif" width="570">

> 👉 **[TeloPon 最新版をダウンロードする](https://github.com/miyumiyu/TeloPon/releases/download/v2.24b/TeloPon-224b.zip)**  
> ⚠️ 緑の「Code」→「Download ZIP」では動きません。必ず Releases からダウンロードしてください。
...
「説明消して」「名前のやつ閉じて」で画面上のウィンドウもAIが閉じます。

### 🎮 ゲーム画面を見て実況
OBS連携でゲーム画面やカメラ映像をAIに見せて、視覚情報に基づいたリアルタイム実況・リアクションが可能。OBSの録画開始/停止も音声で制御。

<img src="images/game.gif" width="570">

### 🐦 SNS連携
X (Twitter) のハッシュタグを自動取得してAIに注入。サムネイルやゲーム画面付きのツイートをAIが自動投稿。

### 🔊 テロップ読み上げ
Windows標準音声（SAPI5）・VOICEVOX・Gemini 3.1 Flash TTSでテロップを自動読み上げ。配信にAIの「声」を追加。
...
👉 **[最新版 TeloPon.zip をダウンロード](https://github.com/miyumiyu/TeloPon/releases/download/v2.24b/TeloPon-224b.zip)**
...
<img src="images/ui_ja-quick.png" width="570">
...
<img src="images/ui_ja.png" width="570">
...
| タブ | できること |
|---|---|
| **アクティブ** | UIに表示中のプラグインを管理。不要なものを非表示に。リロードも可能 |
...
| **UI操作** | 「説明消して」「名前のやつ閉じて」 | 説明ウィンドウ・ネームプレートを非表示 |
...
TeloPon内の **プラグイン管理** →「ダウンロード可能」タブからワンクリックで追加できます。
...
| 🔊 **テロップ読み上げ (Gemini TTS)** | Gemini 3.1 Flash TTSで高品質読み上げ（試用向け、レート制限あり） |
