...
* **手初心者の方でもパソコンやスマホから簡単に取得できるので、以下の手順を順番に進めてみましょう！
...
---くれる **「Auto Talk（沈黙回避）」機能** も標準搭載しています。
...
3. 右上の**「APIキーの作成」** ボタンを押し、キーの作成を行います。表示された「AIza...」から始まる文字列をコピーして大切に保管してください（絶対に他人に教えないでください）。
